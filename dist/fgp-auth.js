...
/***/ "../../node_modules/keycloak-js/dist/keycloak":
/*!***************************!*\
  !*** external "Keycloak" ***!
  \***************************/
...
var KeycloakAuth = /** @class */ (function () {
    function KeycloakAuth(props) {
        ...
        this.props = props;
        this.kc = keycloak_1.default(props.initOpts);
    }
        ...
        this.kc.init(__assign({}, initOpts)).success(function (authenticated) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (!authenticated) {
                    ...
                    _a = this.kc, token = _a.token, tokenParsed = _a.tokenParsed, refreshToken = _a.refreshToken, refreshTokenParsed = _a.refreshTokenParsed;
...
Object.defineProperty(exports, "__esModule", { value: true });
var kecloak_auth_1 = __webpack_require__(/*! ./auth/kecloak.auth */ "./src/auth/kecloak.auth.ts");
exports.KeycloakAuth = kecloak_auth_1.KeycloakAuth;
